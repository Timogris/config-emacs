...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "MenloRegular" :foundry "PfEd" :slant normal :weight normal :height 105 :width normal))))
 '(minimap-active-region-background ((((background dark)) (:background "#2A2A2A222222")) (t (:background "#D3D3D3222222"))) nil :group)
 '(org-level-1 ((t (:inherit default :foreground "#e06c75"))))
 '(org-level-2 ((t (:inherit default :foreground "#98c379"))))
 '(org-level-3 ((t (:inherit default :foreground "#61afef"))))
 '(org-level-4 ((t (:inherit default :foreground "#e5c07b"))))
 '(org-level-5 ((t (:inherit default :foreground "#56b6c2"))))
 '(org-level-6 ((t (:inherit default :foreground "#c678dd"))))
 '(org-level-7 ((t (:inherit default :foreground "#98c379"))))
 '(org-level-8 ((t (:inherit default :foreground "#61afef"))))
